...
var temp__5718__auto____$1 = (o22440["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22441 = temp__5718__auto____$1;
return (o22441["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21521__auto__ = f;
return (o__21521__auto__["toString"]).call(o__21521__auto__);
} else {
return "";
}
}catch (e22442){var _ = e22442;
return "";
}});
...
try{var o__21521__auto___22444 = t;
(o__21521__auto___22444["cljs$lang$ctorPrWriter"]).call(o__21521__auto___22444,t,writer);
}catch (e22443){var __22445 = e22443;
}
...
var char_code = (function (){var o__21521__auto__ = (new String(char$));
return (o__21521__auto__["charCodeAt"]).call(o__21521__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21521__auto__ = String;
return (o__21521__auto__["fromCharCode"]).call(o__21521__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22446 = num_code;
switch (G__22446) {
case (1):
return (185);
...
var o__21521__auto__ = String;
return (o__21521__auto__["fromCharCode"]).call(o__21521__auto__,superscript_code);
});
/**
...
}catch (e22448){var _e__21528__auto__ = e22448;
return false;
}})())){
...
var vec__22449 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22449,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22452 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22452["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22453 = temp__5718__auto____$1;
return (o22453["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22456){
var vec__22457 = p__22456;
var ns_detector = cljs.core.nth.call(null,vec__22457,(0),null);
...
var G__22463 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22464 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22463;
remaining_tokens = G__22464;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22454){
var G__22455 = cljs.core.first.call(null,seq22454);
var seq22454__$1 = cljs.core.next.call(null,seq22454);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22455,seq22454__$1);
});
...
var vec__22468 = cljs.core.split_with.call(null,(function (p1__22467_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22467_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22468,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22468,(1),null);
...
var vec__22474 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22474,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22474,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22477 = cljs.core.rest.call(null,remaining_tokens);
var G__22478 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22477;
name_tokens = G__22478;
continue;
} else {
...
var vec__22481 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22481,(0),null);
var arity = cljs.core.nth.call(null,vec__22481,(1),null);
var vec__22484 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22484,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22484,(1),null);
var vec__22487 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22487,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22487,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22487,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22487,(3),null);
...
var vec__22493 = result;
var munged_ns = cljs.core.nth.call(null,vec__22493,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22493,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22493,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22493,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22493,(4),null);
var arity = cljs.core.nth.call(null,vec__22493,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22497 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22497,(0),null);
var args = cljs.core.nth.call(null,vec__22497,(1),null);
var vec__22500 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22500,(0),null);
var name = cljs.core.nth.call(null,vec__22500,(1),null);
...
var G__22503 = (arity + (1));
var G__22504 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22505){
var vec__22506 = p__22505;
var arity = cljs.core.nth.call(null,vec__22506,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22506,(1),null);
...
return cljs.core.get.call(null,arities,p1__22509_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22510_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___22517 = arguments.length;
var i__4731__auto___22518 = (0);
while(true){
if((i__4731__auto___22518 < len__4730__auto___22517)){
args__4736__auto__.push((arguments[i__4731__auto___22518]));

var G__22519 = (i__4731__auto___22518 + (1));
i__4731__auto___22518 = G__22519;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22513){
var vec__22514 = p__22513;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22514,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22511){
var G__22512 = cljs.core.first.call(null,seq22511);
var seq22511__$1 = cljs.core.next.call(null,seq22511);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22512,seq22511__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22522__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22522__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22522__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22522__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22523 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22523,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22523,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22523,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22523,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22523,(4),null);
var arity = cljs.core.nth.call(null,vec__22523,(5),null);
...
var o__21521__auto__ = f;
return (o__21521__auto__["getBasis"]).call(o__21521__auto__);
});
/**
...
}catch (e22527){var _e__21528__auto__ = e22527;
...
var G__22528 = (obj[cljs.core.first.call(null,path)]);
var G__22529 = cljs.core.rest.call(null,path);
obj = G__22528;
path = G__22529;
continue;
} else {
...
return (function (accum,p__22530){
var vec__22531 = p__22530;
var bit = cljs.core.nth.call(null,vec__22531,(0),null);
var protocol = cljs.core.nth.call(null,vec__22531,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22534){
var vec__22535 = p__22534;
var ns = cljs.core.nth.call(null,vec__22535,(0),null);
var name = cljs.core.nth.call(null,vec__22535,(1),null);
var selector = cljs.core.nth.call(null,vec__22535,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22540,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22540,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22540,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22538_SHARP_){
return (obj[cljs.core.first.call(null,p1__22538_SHARP_)]);
});})(name,sorted_matches,vec__22540,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
