...
var G__22545 = devtools.prefs.pref.call(null,v);
v = G__22545;
continue;
} else {
return v;
...
}catch (e22548){var _e__21528__auto__ = e22548;
return false;
}})();
...
}catch (e22552){var _e__21528__auto__ = e22552;
return false;
}})();
...
}catch (e22554){var _e__21528__auto__ = e22554;
return false;
}}
}
});
...
var vec__22556 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22556,(0),null);
var name = cljs.core.nth.call(null,vec__22556,(1),null);
...
return cljs.core.some.call(null,(function (p1__22559_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22559_SHARP_);
}),template);
});
