...
if((i < len)){
var k = (ks[i]);
var G__25259 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__25260 = (i + (1));
m = G__25259;
i = G__25260;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__25262 = c;
var G__25262__$1 = (((G__25262 == null))?null:G__25262.prototype);
if((G__25262__$1 == null)){
return null;
} else {
return (G__25262__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__25264 = c;
var G__25264__$1 = (((G__25264 == null))?null:G__25264.prototype);
if((G__25264__$1 == null)){
return null;
} else {
return (G__25264__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__25267__delegate = function (args){
...
while (G__25268__i < G__25268__a.length) {G__25268__a[G__25268__i] = arguments[G__25268__i + 0]; ++G__25268__i;}
  args = new cljs.core.IndexedSeq(G__25268__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25269);
...
var _STAR_current_component_STAR__orig_val__25271 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__25272 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__25272;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__25271;
}});
...
return ((function (G__25273,G__25273__$1){
...
var c = this;
var G__25278_25280 = (c["cljsRatom"]);
if((G__25278_25280 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25278_25280);
}
...
var renders_25282 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_25283 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_25282));
if((cljs.core.count.call(null,renders_25282) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_25282))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_25283)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_25283)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__25281 = name;
switch (G__25281) {
case "":
...
var G__25285 = o;
(G__25285[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__25286 = fiber;
var G__25286__$1 = (((G__25286 == null))?null:(G__25286["type"]));
if((G__25286__$1 == null)){
return null;
} else {
return (G__25286__$1["displayName"]);
}
})();
var parent = (function (){var G__25287 = fiber;
if((G__25287 == null)){
return null;
} else {
return (G__25287["return"]);
}
})();
var path = (function (){var G__25288 = parent;
var G__25288__$1 = (((G__25288 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__25288));
if((G__25288__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25288__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__25290 = c;
if((G__25290 == null)){
return null;
} else {
return (G__25290["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__25291._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__25293 = c;
if((G__25293 == null)){
return null;
} else {
return (G__25293["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__25295 = c;
if((G__25295 == null)){
return null;
} else {
return G__25295._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__25297 = instance;
if((G__25297 == null)){
return null;
} else {
return (G__25297["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__25298 = instance;
if((G__25298 == null)){
return null;
} else {
return G__25298._currentElement;
}
}
})();
var name = (function (){var G__25299 = elem;
var G__25299__$1 = (((G__25299 == null))?null:(G__25299["type"]));
if((G__25299__$1 == null)){
return null;
} else {
return (G__25299__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__25301 = elem;
if((G__25301 == null)){
return null;
} else {
return (G__25301["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__25302._owner;
}
}
})();
var path = (function (){var G__25303 = owner;
var G__25303__$1 = (((G__25303 == null))?null:reagent.impl.component.component_path.call(null,G__25303));
if((G__25303__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25303__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__25304 = c;
var G__25304__$1 = (((G__25304 == null))?null:G__25304.constructor);
if((G__25304__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__25304__$1);
}
}
})();
