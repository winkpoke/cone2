...
var G__25307 = o;
(G__25307[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__25308__delegate = function (args){
...
while (G__25309__i < G__25309__a.length) {G__25309__a[G__25309__i] = arguments[G__25309__i + 0]; ++G__25309__i;}
  args = new cljs.core.IndexedSeq(G__25309__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25310);
...
var G__25311 = o;
(G__25311[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25313__i < G__25313__a.length) {G__25313__a[G__25313__i] = arguments[G__25313__i + 0]; ++G__25313__i;}
  args = new cljs.core.IndexedSeq(G__25313__a,0,null);
} 
...
var G__25316 = props;
var G__25316__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25316,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25316);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25316__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25317){
...
var props = map__25318__$1;
var class$ = cljs.core.get.call(null,map__25318__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__25318,map__25318__$1,props,class$){
return (function (c){
...
});})(map__25318,map__25318__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25320){
...
var on_write = cljs.core.get.call(null,map__25321__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25321,map__25321__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25321,map__25321__$1,on_write))
);
} else {
...
var G__25324 = jsprops;
(G__25324["defaultValue"] = value);

(G__25324["onChange"] = ((function (G__25324,v,value,on_change){
return (function (p1__25323_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25323_SHARP_);
});})(G__25324,v,value,on_change))
);
...
var vec__25327 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25327,(0),null);
var id = cljs.core.nth.call(null,vec__25327,(1),null);
var class$ = cljs.core.nth.call(null,vec__25327,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___25331 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___25331 == null)){
} else {
var key_25332 = temp__5724__auto___25331;
(jsprops["key"] = key_25332);
}
...
var temp__5724__auto___25333 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___25333 == null)){
} else {
var key_25334 = temp__5724__auto___25333;
reagent.impl.template.oset.call(null,jsprops,"key",key_25334);
}
...
var G__25335 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25335["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25339){
var G__25340 = cljs.core.first.call(null,seq25339);
var seq25339__$1 = cljs.core.next.call(null,seq25339);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25340,seq25339__$1);
});
...
break;
default:
var G__25346 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25346;
continue;
...
var n__4607__auto___25348 = a.length;
var i_25349 = (0);
while(true){
if((i_25349 < n__4607__auto___25348)){
(a[i_25349] = reagent.impl.template.as_element.call(null,(a[i_25349])));

var G__25350 = (i_25349 + (1));
i_25349 = G__25350;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___25351 = a.length;
var i_25352 = (0);
while(true){
if((i_25352 < n__4607__auto___25351)){
var val_25353 = (a[i_25352]);
if(((cljs.core.vector_QMARK_.call(null,val_25353)) && ((reagent.impl.template.key_from_vec.call(null,val_25353) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25352] = reagent.impl.template.as_element.call(null,val_25353));

var G__25354 = (i_25352 + (1));
i_25352 = G__25354;
continue;
} else {
}
...
var ctx = ({});
var vec__25355 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25355,(0),null);
var derefed = cljs.core.nth.call(null,vec__25355,(1),null);
...
var G__25358 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25358) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25358){
