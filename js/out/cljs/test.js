...
var G__25659 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__25659,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__25659;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq25661){
...
var file = cljs.core.get.call(null,map__25668__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25668__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25668__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__25668,map__25668__$1,file,line,column){
return (function (p1__25667_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__25667_SHARP_));
});})(map__25668,map__25668__$1,file,line,column))
...
var temp__5720__auto___25670 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___25670)){
var message_25671 = temp__5720__auto___25670;
cljs.core.println.call(null,message_25671);
} else {
}
...
var temp__5720__auto___25672 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___25672)){
var message_25673 = temp__5720__auto___25672;
cljs.core.println.call(null,message_25673);
} else {
}
...
var output_dir = "public/js/out";
var output_dir__$1 = (function (){var G__25674 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__25674,"/"].join('');
} else {
return G__25674;
}
})();
...
var G__25676 = exception.stack;
var G__25676__$1 = (((G__25676 == null))?null:clojure.string.split_lines.call(null,G__25676));
var G__25676__$2 = (((G__25676__$1 == null))?null:cljs.core.get.call(null,G__25676__$1,depth));
if((G__25676__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__25676__$2);
}
} else {
...
var vec__25677 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__25677,(0),null);
var column = cljs.core.nth.call(null,vec__25677,(1),null);
var vec__25680 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__25680,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__25680,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__25680,(2),null);
...
var m__$1 = (function (){var G__25683 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__25687 = (function (){var G__25686 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__25686);
} else {
return G__25686;
}
})();
...
return cljs.core.vary_meta.call(null,G__25688,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e25689){var e = e25689;
var G__25690 = e;
var G__25690__$1 = (((G__25690 instanceof cljs.core.Keyword))?G__25690.fqn:null);
switch (G__25690__$1) {
...
var vec__25692 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__25692,(0),null);
var types = vec__25692;
...
return cljs.core.map.call(null,(function (p__25695){
var vec__25696 = p__25695;
var ns = cljs.core.nth.call(null,vec__25696,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__25696,(1),null);
return ((function (vec__25696,ns,vars__$1){
return (function (){
...
var G__25699 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1){
return (function (){
var seq__25700 = cljs.core.seq.call(null,vars__$1);
var chunk__25701 = null;
var count__25702 = (0);
var i__25703 = (0);
while(true){
if((i__25703 < count__25702)){
var v = cljs.core._nth.call(null,chunk__25701,i__25703);
var temp__5720__auto___25705 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___25705)){
var t_25706 = temp__5720__auto___25705;
each_fixture_fn.call(null,((function (seq__25700,chunk__25701,count__25702,i__25703,t_25706,temp__5720__auto___25705,v,each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25706)));
});})(seq__25700,chunk__25701,count__25702,i__25703,t_25706,temp__5720__auto___25705,v,each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1))
);
} else {
}


var G__25707 = seq__25700;
var G__25708 = chunk__25701;
var G__25709 = count__25702;
var G__25710 = (i__25703 + (1));
seq__25700 = G__25707;
chunk__25701 = G__25708;
count__25702 = G__25709;
i__25703 = G__25710;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__25700);
if(temp__5720__auto__){
var seq__25700__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__25700__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__25700__$1);
var G__25711 = cljs.core.chunk_rest.call(null,seq__25700__$1);
var G__25712 = c__4550__auto__;
var G__25713 = cljs.core.count.call(null,c__4550__auto__);
var G__25714 = (0);
seq__25700 = G__25711;
chunk__25701 = G__25712;
count__25702 = G__25713;
i__25703 = G__25714;
continue;
} else {
var v = cljs.core.first.call(null,seq__25700__$1);
var temp__5720__auto___25715__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___25715__$1)){
var t_25716 = temp__5720__auto___25715__$1;
each_fixture_fn.call(null,((function (seq__25700,chunk__25701,count__25702,i__25703,t_25716,temp__5720__auto___25715__$1,v,seq__25700__$1,temp__5720__auto__,each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25716)));
});})(seq__25700,chunk__25701,count__25702,i__25703,t_25716,temp__5720__auto___25715__$1,v,seq__25700__$1,temp__5720__auto__,each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1))
);
} else {
}


var G__25717 = cljs.core.next.call(null,seq__25700__$1);
var G__25718 = null;
var G__25719 = (0);
var G__25720 = (0);
seq__25700 = G__25717;
chunk__25701 = G__25718;
count__25702 = G__25719;
i__25703 = G__25720;
continue;
}
} else {
...
});})(each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1))
);
});})(each_fixture_fn,G__25699,G__25699__$1,env,once_fixtures,each_fixtures,vec__25696,ns,vars__$1))
], null);
