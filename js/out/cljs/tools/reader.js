...
var G__24736 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24736;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24737 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24737,ch);
...
if(("\\" === ch__$1)){
var ch_24738__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24738__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24738__$2);
} else {
}

var G__24739 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24739;
continue;
}
}
...
var vec__24747 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24747,(0),null);
var start_column = cljs.core.nth.call(null,vec__24747,(1),null);
...
var G__24750 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24750;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24751 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24752 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24752;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24751;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24753 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24753,(0),null);
var start_column = cljs.core.nth.call(null,vec__24753,(1),null);
...
var vec__24756 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24756,(0),null);
var end_column = cljs.core.nth.call(null,vec__24756,(1),null);
...
var vec__24768 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24768,(0),null);
var end_column = cljs.core.nth.call(null,vec__24768,(1),null);
...
var sb = (function (){var G__24771 = (new goog.string.StringBuffer());
G__24771.append(initch);
...
var G__24773 = (function (){var G__24772 = sb;
G__24772.append(ch);

return G__24772;
})();
var G__24774 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24773;
ch = G__24774;
continue;
}
...
var vec__24785 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24785,(0),null);
var end_column = cljs.core.nth.call(null,vec__24785,(1),null);
...
var line = cljs.core.nth.call(null,vec__24793,(0),null);
var column = cljs.core.nth.call(null,vec__24793,(1),null);
...
var line = cljs.core.nth.call(null,vec__24798,(0),null);
var column = cljs.core.nth.call(null,vec__24798,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__24809 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24809,true,null,opts,pending_forms);
...
var G__24810 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24810)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24810)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24810)){
...
var _STAR_suppress_read_STAR__orig_val__24811 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24812 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24812;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24811;
}});
...
var G__24813 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24813,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24813,rdr,first_line);
...
var G__24817 = matched;
var G__24818 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24817;
finished = G__24818;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24819 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24820 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24820;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24819;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24821 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24822 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24822;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24823 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24823,"(");
...
var G__24824 = (i + (1));
var G__24825 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24821;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24826 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24826);
...
var G__24827 = cljs.core.next.call(null,s__$1);
var G__24828 = ret;
s__$1 = G__24827;
r = G__24828;
continue;
...
var G__24830 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24829;
key_vals = G__24830;
continue;
} else {
...
var gensym_env_orig_val__24834 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24835 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24835;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24834;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24836 = token;
var G__24836__$1 = (((G__24836 == null))?null:cljs.core.subs.call(null,G__24836,(1)));
var G__24836__$2 = (((G__24836__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24836__$1));
var G__24836__$3 = (((G__24836__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24836__$2));
var G__24836__$4 = (((G__24836__$3 == null))?null:cljs.core.symbol.call(null,G__24836__$3));
if((G__24836__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24836__$4);
}
})():(function (){var G__24837 = token;
var G__24837__$1 = (((G__24837 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24837));
if((G__24837__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24837__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24848,reader){
...
var opts = map__24849__$1;
var eof = cljs.core.get.call(null,map__24849__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24855){
