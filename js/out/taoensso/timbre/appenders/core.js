...
taoensso.timbre.appenders.core.println_appender.cljs$core$IFn$_invoke$arity$variadic = (function (p__28395){
var vec__28396 = p__28395;
var _opts = cljs.core.nth.call(null,vec__28396,(0),null);
return new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"enabled?","enabled?",-1376075057),true,new cljs.core.Keyword(null,"async?","async?",1523057758),false,new cljs.core.Keyword(null,"min-level","min-level",1634684919),null,new cljs.core.Keyword(null,"rate-limit","rate-limit",1748082022),null,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),new cljs.core.Keyword(null,"inherit","inherit",-1840815422),new cljs.core.Keyword(null,"fn","fn",-1175266204),((function (vec__28396,_opts){
...
var output_ = cljs.core.get.call(null,map__28399__$1,new cljs.core.Keyword(null,"output_","output_",-36797880));
...
/** @this {Function} */
taoensso.timbre.appenders.core.println_appender.cljs$lang$applyTo = (function (seq28394){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28394));
});
...
var args__4736__auto__ = [];
var len__4730__auto___28411 = arguments.length;
var i__4731__auto___28412 = (0);
while(true){
if((i__4731__auto___28412 < len__4730__auto___28411)){
args__4736__auto__.push((arguments[i__4731__auto___28412]));

var G__28413 = (i__4731__auto___28412 + (1));
i__4731__auto___28412 = G__28413;
continue;
} else {
}
break;
...
taoensso.timbre.appenders.core.console_appender.cljs$core$IFn$_invoke$arity$variadic = (function (p__28405){
var vec__28406 = p__28405;
var opts = cljs.core.nth.call(null,vec__28406,(0),null);
return new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"enabled?","enabled?",-1376075057),true,new cljs.core.Keyword(null,"async?","async?",1523057758),false,new cljs.core.Keyword(null,"min-level","min-level",1634684919),null,new cljs.core.Keyword(null,"rate-limit","rate-limit",1748082022),null,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),new cljs.core.Keyword(null,"inherit","inherit",-1840815422),new cljs.core.Keyword(null,"fn","fn",-1175266204),(((typeof console !== 'undefined'))?(function (){var level__GT_logger = ((function (vec__28406,opts){
return (function (level){
var or__4131__auto__ = (function (){var G__28410 = level;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28410__$1)].join('')));
...
;
return ((function (level__GT_logger,vec__28406,opts){
return (function (data){
...
;})(level__GT_logger,vec__28406,opts))
})():((function (vec__28406,opts){
return (function (data){
return null;
});})(vec__28406,opts))
)], null);
...
/** @this {Function} */
taoensso.timbre.appenders.core.console_appender.cljs$lang$applyTo = (function (seq28404){
var self__4718__auto__ = this;
